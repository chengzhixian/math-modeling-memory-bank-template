...
进一步对全部 $22\choose2=231$ 个指标对做复制性核对：arxiv 在 A1 有 108 个负相关对，其中 102 个在完整 A2 与去重 A2 中仍为负；github 的 85 个 A1 负相关对全部在完整 A3 与去重 A3 中保持负向。两域共有 59 个指标对在 sample、extended、non-overlap 三层均为负。上述计数是全局定向后的描述性复核，不宣称完成多重比较校正。代表性结果见表\ref{tab:q1_conflict}。
