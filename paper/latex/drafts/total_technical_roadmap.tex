...
\node[module,minimum width=75mm] (q4pre) at (144,97)
  {历史记录整理\quad 指标统一};
\node[module,minimum width=35mm] (history) at (121,84) {历史能力演进};
\node[module,minimum width=35mm] (bridge) at (167,84) {损失—能力映射};
\node[module,minimum width=35mm] (contrib) at (121,71)
  {规模贡献\quad /\quad 技术贡献};
\node[module,minimum width=35mm] (bridgeerr) at (167,71) {映射误差分析};
...
\node[result,minimum width=75mm] (q4out) at (144,26) {未来能力前沿及预测区间};
...
\draw[flow] (bridgeerr.south) -- ++(0,-2) -- (185,64) -- (185,34) -- (uncertainty.east);
\draw[flow] (uncertainty) -- (q4out);

% 两条主线在结论层汇合，问题三不作为问题四的必经输入。
