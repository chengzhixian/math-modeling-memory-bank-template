...
PAPER = (
    "paper/latex/sections/Q3/numerical.tex",
    "paper/latex/sections/Q3/theory.tex",
    "paper/latex/figures/Q3/q3_v8_power_8192.png",
    "outputs/Q3/ANSWER.md",
    "experiments/Q3/EXTERNAL_VALIDATION.md",
)
