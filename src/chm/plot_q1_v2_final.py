...
FIG = ROOT / "paper/latex/figures/Q1"
...
def main():
    observed = rows(ROOT / "outputs/Q1/targetwise_validation.csv")
    estimated = rows(ROOT / "outputs/Q1/estimated_targetwise.csv")
    groups = [
    ...
    bounds = json.loads((ROOT / "outputs/Q1/hull_bounds.json").read_text(encoding="utf-8"))
    assert len(bounds) == 4
