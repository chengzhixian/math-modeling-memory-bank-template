...
from q3_v8_inputs import EXPORT, PINNED_FILES, load_v8, verify_export  # noqa: E402
...
class ConditionalV8Q3Tests(unittest.TestCase):
    ...
    def test_export_rejects_tampered_producer_file(self):
        with tempfile.TemporaryDirectory() as tmp:
            ...
            with self.assertRaisesRegex(ValueError, "integrated producer file changed"):
                verify_export(root)
    ...
    def test_declared_q1_primary_policy_is_below_q0(self):
        position = self.model.q1.recipe_ids.index("136")
        candidate = {"p": self.model.q1.p_dict(self.model.q1.recipes[position]),
                     "weights": self.policy["weights"], "p_policy": "observed_512"}
