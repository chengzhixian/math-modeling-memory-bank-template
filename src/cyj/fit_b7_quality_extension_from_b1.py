...
B1_FILE = ROOT / "outputs/cyj/classic/classic_fit.json"
B7_FILE = ROOT / "outputs/cyj/quality/b7_joint_fit.json"
B7_NESTED = ROOT / "outputs/cyj/quality/b7_nested_cv_summary.json"
