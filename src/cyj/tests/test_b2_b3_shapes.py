...
class ShapeTests(unittest.TestCase):
    def test_counts_increases_and_decreases_after_sorting(self) -> None:
        rows = [
            {"N_params_B": "1", "D_tokens_B": "3", "val_loss": "2.5"},
            {"N_params_B": "1", "D_tokens_B": "1", "val_loss": "3"},
            {"N_params_B": "1", "D_tokens_B": "2", "val_loss": "2"},
        ]
    ...
    def test_rejects_duplicate_training_tokens(self) -> None:
        rows = [
            {"N_params_B": "1", "D_tokens_B": "1", "val_loss": "3"},
            {"N_params_B": "1", "D_tokens_B": "1", "val_loss": "2"},
        ]
    ...
    def test_rejects_mixed_model_sizes(self) -> None:
        rows = [
            {"N_params_B": "1", "D_tokens_B": "1", "val_loss": "3"},
            {"N_params_B": "2", "D_tokens_B": "2", "val_loss": "2"},
        ]
        with self.assertRaises(ValueError):
            describe_curve(rows)
