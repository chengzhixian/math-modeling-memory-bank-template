...
FIT = ROOT / "outputs/cyj/q2_v8/b7_quality_extension.json"
...
class ConditionalV8:
    def __init__(self, root: Path = ROOT):
        ...
        payload = json.loads((self.root / "outputs/cyj/q2_v8/b7_quality_extension.json").read_text(encoding="utf-8"))
        ...
        self.quality_fit_sha256 = sha256(self.root / "outputs/cyj/q2_v8/b7_quality_extension.json")
