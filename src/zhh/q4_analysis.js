...
// C7/C8 preparation and a historical diagnostic; generated tables stay in ignored processed data.
const outputRoot = path.join(repositoryRoot, 'data', 'processed', 'Q4', 'node');
