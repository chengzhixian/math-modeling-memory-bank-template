...
V2 = ROOT / 'outputs/zhh/q4_v2'
OUT = ROOT / 'outputs/zhh/q4_core_v3'
SEED = 20260927
...
def main():
    ...
    dump('interface.json',{'schema':'zhh.q4.core.v3.interface','formal_cross_coordinate_status':'unidentified',
        ...
        'paper_status':'not updated at user request; old v2 paper and root tables are not current v3 core results'})
    ...
    inputs += [Path(__file__),ROOT/'src/zhh/q4_complete.py',ROOT/'src/zhh/test_q4_core_v3.py',
        ...
        ROOT/'experiments/zhh/20260926-q4-core-v3-design.md',
        ROOT/'experiments/zhh/20260926-q4-bridge-primary-source-check.md']
    dump('manifest.json',{'schema':'zhh.q4.core.v3.manifest','git_base':old.git('rev-parse','HEAD'),'seed':SEED,
        ...
        'paper_updated':False,'upstream_Q3_commit':old.Q3_REF,'bootstrap_blocks':80,
