...
const result = JSON.parse(fs.readFileSync(path.join(__dirname, '../../data/processed/Q4/node/q4_results.json'), 'utf8'));
...
const forecastCsv = fs.readFileSync(path.join(__dirname, '../../data/processed/Q4/node/frontier_forecast.csv'), 'utf8');
