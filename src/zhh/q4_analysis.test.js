...
const result = JSON.parse(fs.readFileSync(path.join(__dirname, '../../outputs/zhh/q4_results.json'), 'utf8'));
...
const forecastCsv = fs.readFileSync(path.join(__dirname, '../../outputs/zhh/frontier_forecast.csv'), 'utf8');
