# Q4 v3 conditional interface

Machine-readable status: [`outputs/Q4/interface.json`](../../outputs/Q4/interface.json). Producer: `src/zhh/q4_core_v3.py`; upstream preparation: `src/zhh/q4_analysis.js` and `src/zhh/q4_complete.py`. Numerical source version `team/zhh-frontier@ee23b200e9de7f78477d945b186233741bd3b8fd`.
