...
正式运行提交 `3b9cbff1362349bd9dc9d94d56c409f7d93654be` 得到 E=1.6898377713、A=0.3539687193、B=1.2402746295、alpha=0.3399854258、beta=0.2798924656。这些数值是 B1 上的点估计，不是全队已冻结参数。
...
机器可读结果见 `outputs/cyj/classic/classic_fit.json`，SHA256 `b3706500bf79c191b7b05bf7af3dd963d1fb149fe47e304edb30cc9ad023893e`。该文件显式给出 `ready_for_Q3=false`，理由是 B4/B5 绝对 Loss 可比性、Q/p 标定和不确定性区间均未完成。
